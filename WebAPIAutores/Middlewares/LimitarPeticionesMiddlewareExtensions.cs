...
namespace WebAPIAutores.Middlewares
{
    ...
    {
        public static IApplicationBuilder UserLimitarPeticiones(this IApplicationBuilder app)
        {
    ...
    public class LimitarPeticionesMiddleware
    {
        ...
        public bool PeticionSuperaAlgunaDeLasRestricciones(LlaveAPI llaveAPI, HttpContext httpContext)
        {
            if (llaveAPI.RestriccionesDominio?.Any() == null || llaveAPI.RestriccionesIP?.Any() == null)
            {
                return true;
            }
        ...
        public bool PeticionSuperaLasRestriccionesDeIP(List<RestriccionIP> restricciones, HttpContext httpContext)
        {
        ...
        public bool PeticionSuperaLasRestriccionesDeDominio(List<RestriccionDominio> restricciones, HttpContext httpContext)
        {
            if (restricciones == null || restricciones.Count == 0) { return false; }
